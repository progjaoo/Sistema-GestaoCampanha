...
function ShareAgendaDialog({ weekStart, weekLabel: selectedWeekLabel, onClose }: { weekStart: Date; weekLabel: string; onClose: () => void }) {
  ...
  return <div className="fixed inset-0 z-50 flex items-end justify-center bg-primary/35 p-0 sm:items-center sm:p-6"><section className="w-full max-w-4xl rounded-t-2xl bg-card p-6 shadow-2xl sm:rounded-2xl">
