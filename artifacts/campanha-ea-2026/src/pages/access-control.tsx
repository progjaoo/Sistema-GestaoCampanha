...
import { useListCities, useListLeaderships, useListRegions } from "@workspace/api-client-react";
...
function CreateUserDialog({ regions, cities, onClose, onCreated }: { regions: Array<{ id: number; name: string }>; cities: Array<{ id: number; name: string; regionName: string }>; onClose: () => void; onCreated: (user: UserRow) => void }) {
  const [form, setForm] = useState({ fullName: "", email: "", password: "", role: "COORDENADOR", regionId: "", cityId: "", leadershipId: "", canCreateLeaderUsers: false });
  const [error, setError] = useState("");
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setError("");
    try {
      const body = { ...form, regionId: form.regionId ? Number(form.regionId) : null, cityId: form.cityId ? Number(form.cityId) : null, leadershipId: form.leadershipId ? Number(form.leadershipId) : null };
