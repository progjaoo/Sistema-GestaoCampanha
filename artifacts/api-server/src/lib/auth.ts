...
export const PERMISSION_DEFINITIONS = [
  ...
  },
  {
    key: "boards:view",
    label: "Ver quadros",
    description: "Consultar quadros ativos e arquivados dentro do território autorizado.",
    category: "Operações",
  },
  {
    key: "boards:create",
    label: "Criar quadros",
    description: "Criar quadros operacionais para o próprio escopo.",
    category: "Operações",
  },
  {
    key: "boards:update",
    label: "Editar quadros",
    description: "Editar informações dos quadros autorizados.",
    category: "Operações",
  },
  {
    key: "boards:archive",
    label: "Arquivar quadros",
    description: "Arquivar e reativar quadros autorizados sem apagar os dados.",
    category: "Operações",
  },
  {
    key: "tasks:create",
  ...
  {
    key: "tasks:collaborate",
    label: "Colaborar em tarefas",
    description: "Gerenciar membros, checklist e comentários das tarefas autorizadas.",
    category: "Operações",
  },
  {
    key: "calendar:view",
